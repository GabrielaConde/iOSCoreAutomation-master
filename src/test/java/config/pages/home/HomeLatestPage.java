...
public class HomeLatestPage extends CommonPage {
   ...
   private final By style = MobileBy.AccessibilityId("Style");
    ...
    public void clickOnMaybeLater(){
        driver.findElement(maybeLaterBtn).click();
    }

    public void clickOnHomeIcon() {
        driver.findElement(homeFooter).click();
    }
    ...
    public void closeTrendingVideo() {
        driver.findElement(closeVideo).click();
    }
    ...
    public void tapOnRecentlyViewed() {
    ...
    public void tapOnCelebrity() {
        driver.findElement(celebrity).click();
    }
    ...
    public void tapOnTVAndMovies() {
        driver.findElement(tvAndMovies).click();
    }
    ...
    public void tapOnCoronavirus() {
        driver.findElement(coronavirus).click();
    }

    //  public void tapOnShopping(){driver.findElement(shopping).click();}
    public void tapOnVideos() {
        driver.findElement(videos).click();
    }

    public void tapOnShows() {
        driver.findElement(shows).click();
    }

    public void tapOnAnimals() {
        driver.findElement(animals).click();
    }

    public void tapOnBooks() {
        driver.findElement(books).click();
    }

    public void tapOnCommunity() {
        driver.findElement(community).click();
    }

    public void tapOnHealth() {
        driver.findElement(health).click();
    }

    public void tapOnLGBTQ() {
        driver.findElement(lgbtq).click();
    }
    ...
    public void tapOnNifty() {
        driver.findElement(nifty).click();
    }

    public void tapOnParents() {
        driver.findElement(parents).click();
    }

    public void tapOnRewind() {
        driver.findElement(rewind).click();
    }

    public void tapOnStyle() {
        driver.findElement(style).click();
    }

    public void tapOnTravel() {
