...
public class RecentSearchesTests2 extends SearchInit {
    ...
    @Test(priority = 6)
    public void testRemoveRecent() throws RuntimeException {
        testName("Verify that recent seaches were removed");

            Assert.assertFalse(recent.recentSearchTermIsPresent());

            print("Verified Recent Searches is no longer displayed");
